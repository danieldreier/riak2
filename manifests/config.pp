...
class riak2::config {
  ...
  # those
  $base_settings = merge($default_settings,$::riak2::params::settings)
  $merged_settings = merge($base_settings,$::riak2::settings)
  file { $::riak2::params::riak_conf:
    owner   => $::riak2::params::riak_user,
    group   => $::riak2::params::riak_group,
    mode    => '0644',
